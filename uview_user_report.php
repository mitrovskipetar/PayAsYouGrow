...
$totalLicencedPorts = $totalXgsponPorts - ($xgsponPortsCount * 4);
...
<body>
    ...
    <table class="table">
            ...
            <thead>
                <tr style="border-bottom-style : hidden!important;">
                    <th scope="col" class="col-md-2">Licenced XGS Ports Added</th>
            ...
            <tbody>
                ...
                <?php
                    $totalLicencedPorts = $totalLicencedPorts - ($log->ports - 4);
                }
                ?>
            </tbody>
        </table>
        <div>
            <input type="button" class="btn btn-secondary ml-2" style="position:absolute; bottom:7%; left:5%;" onclick="location.href = 'index.php';" value="Return to home">
        </div>
    ...
    <div class="counter">
        <button class="port-counter" disabled="true">
